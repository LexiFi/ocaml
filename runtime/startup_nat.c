...
#define _GNU_SOURCE
/* This define avoids a redirection from sscanf to __isoc99_sscanf for recent versions of glibc
   and thus makes libasmrun.a compatible with older version of the glibc.
*/
