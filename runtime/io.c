...
/* [[ LexiFi patch */
int caml_min_active_fd = 0;
int caml_silent_mode = 0;

CAMLprim value caml_ml_enable_stdout_stderr(value enable)
{
  CAMLparam1 (enable);
  caml_silent_mode = (enable == Val_false);
  caml_min_active_fd = (caml_silent_mode ? 3 : 0);
  CAMLreturn (Val_unit);
}
/* ]] */
