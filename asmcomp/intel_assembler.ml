...
let imm8_of_float_condition condition = match condition with
  | EQf -> 0
  | LTf -> 1
  | LEf -> 2
  | UNORDf -> 3
...
let emit_cmpsd b condition dst src =
  ...
  | Regf reg, (Regf _ | Mem _ | Mem64_RIP _ as rm) ->
      ...
      buf_int8 b (imm8_of_float_condition condition)
  | _ -> assert false
...
let emit_movd b dst src =
  match dst, src with
  | Reg64 reg, ((Reg64 _ | Mem _ | Mem64_RIP _) as rm) ->
      emit_mod_rm_reg b no_rex [ 0xf; 0x6E ] rm (rd_of_reg64 reg)
  | Regf reg, ((Reg64 _ | Mem _ | Mem64_RIP _) as rm) ->
      buf_int8 b 0x66;
      emit_mod_rm_reg b rexw [ 0xf; 0x6E ] rm (rd_of_regf reg)
  | (Mem _ | Mem64_RIP _  as rm) , Reg64 reg ->
      emit_mod_rm_reg b no_rex [ 0xf; 0x7E ] rm (rd_of_reg64 reg)
  | (Mem _ | Mem64_RIP _ | Reg64 _ as rm) , Regf reg ->
      buf_int8 b 0x66;
      emit_mod_rm_reg b rexw [ 0xf; 0x7E ] rm (rd_of_regf reg)
