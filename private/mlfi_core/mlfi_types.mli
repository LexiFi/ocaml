...
module Internal: sig
  val create_variant_type: string -> stype list -> (stype -> (string * stype_properties * stype variant_args) list * variant_repr) -> stype
  ...
  val set_node_variant: node -> ((string * stype_properties * stype variant_args) list * variant_repr) -> unit
