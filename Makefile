...
typing_SOURCES = \
  ...
  typing/dtype.mli typing/dtype.ml \
  ...
  typing/mlfi_types_internal.mli typing/mlfi_types_internal.ml \
  typing/typedynamic.mli typing/typedynamic.ml \
...
lambda_SOURCES = $(addprefix lambda/, \
  ...
  transldynamic.mli transldynamic.ml \
...
intel_SOURCES = \
  ...
  coff.mli coff.ml \
  intel_assembler.mli intel_assembler.ml \
  intel_coff.mli intel_coff.ml
...
OCAML_LIBRARIES = \
  $(COMPILERLIBS) \
  ocamldoc/odoc_info otherlibs/dynlink/dynlink
...
# BEGIN LEXIFI
typing/mlfi_types_internal.mli: ../private/mlfi_core/mlfi_types.mli
	cd typing; $(LN) ../$< $(notdir $@)

typing/mlfi_types_internal.ml: ../private/mlfi_core/mlfi_types.ml
	cd typing; $(LN) ../$< $(notdir $@)

beforedepend:: typing/mlfi_types_internal.mli typing/mlfi_types_internal.ml
# END LEXIFI
...
# ocamltest is omitted from this vendored source tree.
