...
static DWORD do_create_process_native(BOOL breakaway, wchar_t * exefile, wchar_t * cmdline,
...
value caml_unix_create_process_native(value breakaway, value cmd, value cmdline, value env,
                                 value fd1, value fd2, value fd3)
{
  ...
  err =
    do_create_process_native(Bool_val(breakaway), exefile, wcmdline, wenv, Handle_val(fd1),
