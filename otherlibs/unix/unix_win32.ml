...
external create_process_stub : bool (* break away *) ->
...
let create_process prog args fd1 fd2 fd3 =
  create_process_stub false prog (make_cmdline args) None fd1 fd2 fd3

let create_process_env prog args env fd1 fd2 fd3 =
  create_process_stub false prog (make_cmdline args)
...
let open_proc prog cmdline optenv proc input output error =
  let pid = create_process_stub false prog cmdline optenv input output error in
